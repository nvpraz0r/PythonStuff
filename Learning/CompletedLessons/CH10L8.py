def get_most_common_enemy(enemies_dict):
    ...
    # FIRST detect if dictionary is empty
    ...
    for i in enemies_dict:
        # capture the key's value
        num = enemies_dict[i]
        # check if the key's value is greater than
        # the CURRENT greatest recorded amount of enemies
        if num > max_so_far:
            # set the max to the greatest
            max_so_far = num
            # set the return variable to the key
            # of the greatest number of enemies
            result_name = i
    
    # return the name of the greatest recorded number of enemies
    return result_name
